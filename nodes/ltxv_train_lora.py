    ...
    def INPUT_TYPES(cls):
        ...
        return {
            ...
            "optional": {
                ...
                "rose_stabilize":         ("BOOLEAN", {"default": True, "tooltip": "Rose only: Smooths noisy gradient ranges. In some cases, disabling it might produce better results."}),
                ...
                "rose_wd_schedule":       ("BOOLEAN", {"default": True, "tooltip": "Rose only: Scale weight decay with LR schedule so decay weakens as LR drops. Recommended when using a scheduler."}),
