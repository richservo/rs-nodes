...
class RSLTXVICLoRAGuider:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "rediffusion_passes": ("INT", {"default": 1, "min": 0, "max": 10, "step": 1,
                                               "tooltip": "Number of half-res re-diffusion passes (stage 2). Set to 0 to skip rediffusion entirely (first pass only)."}),
    ...
    def create_guider(
        ...
        lora_strength=1.0, control_strength=1.0, free_mask=None,
        guide_frame_idx=0, crf=35,
